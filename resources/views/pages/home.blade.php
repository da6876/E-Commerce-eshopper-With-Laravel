...
<div class="col-sm-9 padding-right">
    <div class="features_items"><!--features_items-->
        ...
        @foreach($all_live_product as $tv_live_product)
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                        <img src="{{asset($tv_live_product->product_image)}}" alt="" width="268px" height="249px"/>
                        <h2>{{$tv_live_product->product_price}} Tk</h2>
                        <p>{{$tv_live_product->product_name}}</p>
                ...
                <div class="choose">
                    <ul class="nav nav-pills nav-justified">
                        ...
                        <li><a href="{{URL::to('/show-product').'/'.$tv_live_product->product_name}}"><i class="fa fa-plus-square"></i>View Product</a></li>
                    </ul>
                </div>
            </div>
        </div>
