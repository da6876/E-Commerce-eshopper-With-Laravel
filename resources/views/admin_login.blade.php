                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <div class="alert alert-danger" role="alert">
                                    ...
                                    ?>
                                <form class="user" method="post" action="{{url('admin-dashbord')}}">
                                    {{ csrf_field()  }}
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user" name="admin_name"  aria-describedby="emailHelp" placeholder="Enter Email">
                                    </div>
                                    <div class="form-group">
