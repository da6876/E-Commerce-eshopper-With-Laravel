...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{URL::to('/admin/dashbord')}}">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{URL::to('/admin/dashbord')}}">
        ...
        <li class="nav-item">
            ...
            <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{URL::to('/add-catagory')}}">Add Catagory</a>
                    <a class="collapse-item" href="{{URL::to('/all-catagory')}}">Catagory List</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{URL::to('/all-brand')}}">Brand List</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{URL::to('/add-product')}}">Add Products</a>
                    <a class="collapse-item" href="{{URL::to('/all-product')}}">Products List</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{URL::to('/all-slider')}}">Slider List</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
