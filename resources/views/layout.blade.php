            ...
            <div class="row">
                <div class="col-md-4 clearfix">
                    <div class="logo pull-left">
                        <a href="{{URL::to('/')}}"><img src="{{asset('public/images/home/logo.png')}}" alt=""/></a>
                    </div>
                ...
                <div class="col-md-8 clearfix">
                    <div class="shop-menu clearfix pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <?php $cutomer_id = Session::get('customer_id'); ?>
                            @if($cutomer_id!=NULL)
                                <li><a href="{{URL::to('/checkout')}}"><i class="fa fa-crosshairs"></i> Checkouts</a></li>
                            @else
                                <li><a href="{{URL::to('/login-check')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                            @endif
                            <li><a href="{{URL::to('/show-card')}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                            @if($cutomer_id!=NULL)
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li><a href="{{URL::to('/')}}" class="">Products</a></li>
                            <li><a href="{{URL::to('/show-card')}}" class="">Cart</a></li>
                            <li><a href="{{URL::to('/login-check')}}" class="">Checkout</a></li>
                            <li class="dropdown"><a href="{{URL::to('/')}}">Blog</a></li>
